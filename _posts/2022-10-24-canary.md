...
keywords: "son,blog,infra,docker,minikube,kubernetes,grafana,canary"
categories: [Infra]
tags: [son,blog,infra,docker,minikube,kubernetes,grafana,canary]
icon: icon-html
---
...
[&nbsp;&nbsp; 1.2. Canary 실습](#list1_2)

[&nbsp;&nbsp; 1.3. Grafana dashboard 확인](#list1_3)

---

## <span style="color:purple">**1. Canary 배포**</span> <a name="list1"></a>

<br>

### 1.1. Canary란? <a name="list1_1"></a>
...
### 1.2. Canary 실습 <a name="list1_2"></a>
  ...
  다음 영상은 app-v1.yaml 파일이 배포되어 있고 위의 app-v2.yaml을 배포하는 과정에서 pod가 어떻게 변화하는지를 살펴볼 수 있도록 촬영해보았다.
