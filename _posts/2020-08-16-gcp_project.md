---
layout: post
title: "[Project] GCP를 활용한 웹사이트 구축과 모니터링 및 부하 테스트"
date: 2020-08-16
desc: "[Project] GCP를 활용한 웹사이트 구축과 모니터링 및 부하 테스트"
keywords: "project,gcp,cloud sql,stack driver,load balancing,auto scaling"
categories: [Project]
tags: [project,gcp,cloud sql,stack driver,load balancing,auto scaling]
icon: icon-html
---

구현 과정 및 설정까지 작성하여 포스팅이 다소 길지만, 프로젝트성으로 진행되어 포스팅을 따로 나누지 않고 하나의 포스팅으로 작성하였다.
...
### **1.2. 프로젝트 아키텍처**   <a name="list1_2"></a>
...
## **2. 프로젝트 구현**   <a name="list2"></a>

<br>

### **2.1. Cloud SQL 구성**   <a name="list2_1"></a>
...
### **2.2. VM 인스턴스 생성 및 워드프레스 구축**   <a name="list2_2"></a>
...
### **2.3. VM 인스턴스와 Cloud SQL 연동**   <a name="list2_3"></a>
...
### **2.4. 관리형 로드 밸런싱 구성**   <a name="list2_4"></a>
...
### **2.5. Bucket 생성 및 백업 설정**   <a name="list2_5"></a>
...
### **2.6. Stack Driver를 활용한 모니터링 및 로깅 시스템 구축**   <a name="list2_6"></a>
...
## **3. 프로젝트 테스트**   <a name="list3"></a>

<br>

### **3.1. Cloud SQL 로깅 테스트**   <a name="list3_1"></a>
...
### **3.2. 오토 스케일링 및 부하 테스트**   <a name="list3_2"></a>
